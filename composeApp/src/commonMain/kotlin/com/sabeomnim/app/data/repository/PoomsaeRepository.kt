...
object PoomsaeRepository {
    ...
    val poomsaeTaegeuk2 = Poomsae(
        ...
        steps = listOf(
            ...
            PoomsaeStep(7, 16000, 19000, "왼 앞서기 아래막기", "Oen Ap-seogi Arae-makgi", "Turn left 90°, left walking stance, low block", "Drej 90° til venstre, venstre gå-stand, lav blokade", "Ap-seogi", "Arae-makgi", "Keep torso upright.", "Hold overkroppen oprejst."),
            PoomsaeStep(8, 19000, 22500, "오른 앞차기 + 오른 앞굽이 얼굴지르기", "Oreun Ap-chagi + Oreun Ap-kubi Olgul-jireugi", "Right front kick, right forward stance, high punch", "Højre frontspark, land i højre lang stand, højt stød", "Ap-kubi", "Ap-chagi + Olgul-jireugi", "Punch directed at philtrum.", "Stød rettet mod næsehøjde."),
            PoomsaeStep(9, 22500, 25500, "오른 앞서기 아래막기", "Oreun Ap-seogi Arae-makgi", "Turn right 180°, right walking stance, low block", "Drej 180° til højre, højre gå-stand, lav blokade", "Ap-seogi", "Arae-makgi", "Quick rotation.", "Hurtig vending."),
            PoomsaeStep(10, 25500, 29000, "왼 앞차기 + 왼 앞굽이 얼굴지르기", "Oen Ap-chagi + Oen Ap-kubi Olgul-jireugi", "Left front kick, left forward stance, high punch", "Venstre frontspark, land i venstre lang stand, højt stød", "Ap-kubi", "Ap-chagi + Olgul-jireugi", "Chamber kick high before punching.", "Løft knæet højt før stød."),
            PoomsaeStep(11, 29000, 32000, "왼 앞서기 얼굴막기", "Oen Ap-seogi Olgul-makgi", "Turn left 90°, left walking stance, high block", "Drej 90° til venstre, venstre gå-stand, høj blokade", "Ap-seogi", "Olgul-makgi", "Forearm angle 45° above forehead.", "Underarm i 45° vinkel over panden."),
            PoomsaeStep(12, 32000, 35000, "오른 앞서기 얼굴막기", "Oreun Ap-seogi Olgul-makgi", "Step forward, right walking stance, high block", "Gå frem i højre gå-stand, høj blokade", "Ap-seogi", "Olgul-makgi", "Maintain one fist distance from forehead.", "Hold én knytnæves afstand til panden."),
            PoomsaeStep(13, 35000, 38500, "왼 앞서기 몸통 안막기", "Oen Ap-seogi Momtong An-makgi", "Turn left 270°, left walking stance, inner middle block", "Drej 270° til venstre, venstre gå-stand, indadgående midter blokade", "Ap-seogi", "Momtong An-makgi", "Large turn balancing on ball of right foot.", "Stor vending med balance på højre forfod."),
            PoomsaeStep(14, 38500, 41500, "오른 앞서기 몸통 안막기", "Oreun Ap-seogi Momtong An-makgi", "Turn right 180°, right walking stance, inner middle block", "Drej 180° til højre, højre gå-stand, indadgående midter blokade", "Ap-seogi", "Momtong An-makgi", "Block inward towards center solar plexus.", "Blokér indad mod midterlinjen."),
            PoomsaeStep(15, 41500, 44500, "왼 앞서기 아래막기", "Oen Ap-seogi Arae-makgi", "Turn left 90° towards back line, left walking stance, low block", "Drej 90° mod baglinjen, venstre gå-stand, lav blokade", "Ap-seogi", "Arae-makgi", "Start the final returning line.", "Start på den afsluttende returlinje."),
            PoomsaeStep(16, 44500, 47000, "오른 앞차기 + 오른 앞서기 몸통 바로지르기", "Oreun Ap-chagi + Oreun Ap-seogi Momtong Baro-jireugi", "Right front kick, right walking stance, middle punch", "Højre frontspark, land i højre gå-stand, midter stød", "Ap-seogi", "Ap-chagi + Momtong Baro-jireugi", "Snap kick and punch crisply.", "Snertende spark og præcist stød."),
            PoomsaeStep(17, 47000, 49500, "왼 앞차기 + 왼 앞서기 몸통 바로지르기", "Oen Ap-chagi + Oen Ap-seogi Momtong Baro-jireugi", "Left front kick, left walking stance, middle punch", "Venstre frontspark, land i venstre gå-stand, midter stød", "Ap-seogi", "Ap-chagi + Momtong Baro-jireugi", "Keep steady rhythm.", "Hold en jævn rytme."),
            PoomsaeStep(18, 49500, 54000, "오른 앞차기 + 오른 앞서기 몸통 바로지르기 (기합)", "Oreun Ap-chagi + Oreun Ap-seogi Momtong Baro-jireugi (Kihap)", "Right front kick, right walking stance, middle punch with Kihap!", "Højre frontspark, land i højre gå-stand, midter stød med kraftigt Kihap!", "Ap-seogi", "Ap-chagi + Momtong Baro-jireugi", "Explosive final kick and punch with yell.", "Eksplosivt afsluttende spark og stød med råb.", isKihap = true)
        )
    )
